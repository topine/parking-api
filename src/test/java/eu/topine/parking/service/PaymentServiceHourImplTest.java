...
@PrepareForTest(PaymentServiceHourImpl.class)
class PaymentServiceHourImplTest {
    ...
    @BeforeEach
    public void setUp() {
        this.paymentService = PowerMockito.spy(new PaymentServiceHourImpl());
    ...
    public void testHourCalculation2hrs() {
        ...
        assertEquals(Money.of(4, "USD"), paymentService.pricePeriod(localTime, localTimeFuture));
    }
    ...
    public void testHourCalculation1week() {
        ...
        assertEquals(Money.of(2 * 24 * 7, "USD"), paymentService.pricePeriod(localTime, localTimeFuture));
    }
